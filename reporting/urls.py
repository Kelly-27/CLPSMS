...
from .views import (reporting_desk, view_officers, delete_officer, report_case, generate_case_pdf, view_cases,
                    ...
                    commander_dashboard, add_evidence, view_evidence, view_inventory, add_inventory_item,
                    update_inventory_item, view_rosters, add_roster)
...
urlpatterns = [
    ...
    path('commander-dashboard/', commander_dashboard, name='commander_dashboard'),
